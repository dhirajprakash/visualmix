 ...
 * 
 * import org.hibernate.Criteria; import org.hibernate.SQLQuery; import
 * org.hibernate.SessionFactory; import org.hibernate.transform.Transformers;
 ...
 * @Transactional("trans")
 * 
 * @SuppressWarnings({ "unchecked", "rawtypes" }) public class UseIt {
 * 
 ...
 * public List<String> getDataWeakely(HttpServletResponse response, WebRequest
 * webRequest) { SQLQuery q = sessionFactory.getCurrentSession().createSQLQuery(
 ...
 * public List<PlacaDetails> getPleaceDetail(HttpServletResponse response,
 * WebRequest webRequest) { Criteria cr =
